...
import com.bocsoft.callforcode.service.LoanService;
...
public class Loan {
	...
	@PostMapping("/loan")
	@ApiOperation(value="客户发起贷款申请", consumes="application/x-www-form-urlencoded;charset=UTF8")
	@ApiImplicitParams({
	...
	public @ResponseBody HttpCommonResponse queryAccount(@RequestParam String identityID,
		...
		httpCommonResponse = loanService.loanService(identityID, channel, uuid, loanCode, amount);
